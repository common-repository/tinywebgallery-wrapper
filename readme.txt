...
== Upgrade Notice ==
= 2.4.1 =
Fixed loading errors when WP 6.0.1 and php 8.1 is used. Please use advanced iframe as this software is not developed anymore. It was only updated to show not any errors in php 8.1

= 2.4 =
Added support for Wordpress 4.5
Replaced depricated get_currentuserinfo() with wp_get_current_user()
